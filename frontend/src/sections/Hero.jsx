...
//           >
//             A Creative <span className="text-purple-400">Frontend Developer</span>{" "}
//             & Problem Solver
//           </motion.p>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-purple-400 font-semibold">
              modern full-stack web applications and AI-powered solutions 
            </span>{" "}
            using React, Node.js, and MongoDB — delivering scalable systems with clean design and {" "}
            <span className="text-purple-400 font-semibold">
