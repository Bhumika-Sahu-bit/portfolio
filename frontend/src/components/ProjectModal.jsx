...
//                       <div
//                         key={i}
//                         className="text-xs text-cyan-300 bg-cyan-500/10 border border-cyan-500/20 px-3 py-2 rounded-lg hover:bg-cyan-500/20 transition"
//                       >
//                         ✦ {f}
//                       </div>
//                     ))}
